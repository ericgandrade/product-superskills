...
Examples:
  ...
  npx product-superskills --local                   # Install to current project
  npx product-superskills --local -y                # Auto install locally
  npx product-superskills update --local            # Update local skills only
  npx product-superskills uninstall --local -y      # Remove local skills
`);
}
